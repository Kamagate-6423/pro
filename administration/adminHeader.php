	...
	<div class="corp">
		<div class="container-fluid sociaux">
			<div class="col-xs-4 col-sm-3 col-md-2 col-lg-3 ">
				<div class="col-sm-6 col-md-6 col-lg-6"><a href="../view/client.php?connecter=connecter" >Connexion</a></div>
			</div>
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> KONATE BAKARY </div>
				  ...
				  <ul class="nav navbar-nav">
					...
					<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Produits <span class="caret"></span></a>
					  <ul class="dropdown-menu">
						...
						<li><a href="../index/index.php?page1=pouletsVivantsCokeles">Supprimer produits</a></li>
					  </ul>
					</li>
					<li>
